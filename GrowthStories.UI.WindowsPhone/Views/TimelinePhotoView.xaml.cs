...
namespace Growthstories.UI.WindowsPhone
{
    ...
    public partial class TimelinePhotoView : TimelinePhotoViewBase
    {
        ...
        protected override void OnViewModelChanged(IPlantPhotographViewModel vm)
        {
            ...
            //if (!ResetImages.Contains(vm.PlantActionId))
            //{  
            //}

            ViewModel.Log().Info("bitmapcache reset for " + vm.PlantActionId);
            ViewHelpers.ResetImage(ImageControl);
            //ResetImages.Add(vm.PlantActionId);
        }
