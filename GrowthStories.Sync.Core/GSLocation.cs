...
namespace Growthstories.Sync
{
    ...
    public class GSLocation
    {
        ...
        public GSLocation(float lat, float lo)
        {
            this.latitude = lat;
            this.longitude = lo;
        }

        public String FriendlyLatitude()
        {
            return GeoAngle.FromDouble(latitude).ToString();
        }

        public String FriendlyLongitude()
        {
            return GeoAngle.FromDouble(longitude).ToString();
        }
