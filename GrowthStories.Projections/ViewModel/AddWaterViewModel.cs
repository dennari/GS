...
{
    public interface IAddWaterViewModel : IGSRoutableViewModel, IHasAppBarButtons, IControlsAppBar
    {

    }

    public class AddWaterViewModel : RoutableViewModel, IAddWaterViewModel
    {

        private readonly PlantState State;


        public AddWaterViewModel(PlantState state, IGSApp app)
            : base(app)
        {
        ...
        public ReactiveCommand AddCommand
        {
            get
            {
                ...
                if (_AddCommand == null)
                {
                    ...
                    {
                        App.Bus.SendCommand(new Water(this.State.UserId, this.State.Id, this.Note));
