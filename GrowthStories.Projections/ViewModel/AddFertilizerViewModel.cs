...
{
    public interface IAddFertilizerViewModel : IGSRoutableViewModel, IHasAppBarButtons, IControlsAppBar
    {

    }

    public class AddFertilizerViewModel : RoutableViewModel, IAddFertilizerViewModel
    {

        private readonly PlantState State;


        public AddFertilizerViewModel(PlantState state, IGSApp app)
            : base(app)
        {
        ...
        public ReactiveCommand AddCommand
        {
            get
            {
                ...
                if (_AddCommand == null)
                {
                    ...
                    {
                        App.Bus.SendCommand(new Fertilize(this.State.UserId, this.State.Id, this.Note));
