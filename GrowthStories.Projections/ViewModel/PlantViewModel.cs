...
namespace Growthstories.UI.ViewModel
{
    ...
    public class PlantViewModel : GSViewModelBase, IHandles<ShowPlantView>
    {
        ...
        /// </summary>
        public PlantViewModel(IMessenger messenger, IUserService ctx, IDispatchCommands handler, INavigationService nav, ActionProjection actionProjection)
        ...
        {
            Handler.Handle<User, Comment>(command);
        }

        public void Add(Fertilize command)
        {
            Handler.Handle<User, Fertilize>(command);
        }

        public void Add(Water command)
        {
            Handler.Handle<User, Water>(command);

        }

        public void Add(Photograph command)
        {
            Handler.Handle<User, Photograph>(command);
