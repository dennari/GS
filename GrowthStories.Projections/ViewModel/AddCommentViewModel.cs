...
{
    public interface IAddCommentViewModel : IGSRoutableViewModel, IHasAppBarButtons, IControlsAppBar
    {

    }

    public class AddCommentViewModel : RoutableViewModel, IAddCommentViewModel
    {

        private readonly PlantState State;


        public AddCommentViewModel(PlantState state, IGSApp app)
            : base(app)
        {
        ...
        public ReactiveCommand AddCommand
        {
            get
            {
                ...
                if (_AddCommand == null)
                {
                    ...
                    {
                        App.Bus.SendCommand(new Comment(this.State.UserId, this.State.Id, this.Note));
